...
/*
  ...
  Plugin URI: https://github.com/igorlesovsky/mailigen-widget/
...
class Mailigen_Options
{
    ...
    function fieldsConfig()
    {
        ...
        return array(
            ...
            'mg_login_apikey' => array(
                'id' => 'mg-login-apikey',
                'section' => 'sect_mg_login',
                'type' => 'text',
                'title' => __('Mailigen API Key'),
                'value' => '',
                'desc' => __('Enter Mailigen API Key - <a href="https://admin.mailigen.com/settings/api" target="_blank">Mailigen API Settings</a>.')
            ),
            'mg_login' => array(
                'id' => 'mg-login',
                'section' => 'sect_mg_login',
